                ...
                {sampleCandidates && (
                  <BorderedPanel>
                    <ExplorePane
                      ...
                      title={null}
                      description={t`This seems to be taking a while. In the meantime, you can check out one of these example explorations to see what Plena Data can do for you.`}
                    />
                  </BorderedPanel>
                )}
              </div>
